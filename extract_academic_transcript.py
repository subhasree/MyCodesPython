...
for root, dirs, files in os.walk("/home/sbasu/Videopedia_MM/extractedWords"):
    ...
    for file in files:
          #print file
          file_path = os.path.join("/home/sbasu/Videopedia_MM/extractedWords", file)
          string1 = convert_meta_academic(process_metadata_file(file_path), meta_words)
          write_file_path = os.path.join("/home/sbasu/Videopedia_MM/extractedWords_academic", file)
